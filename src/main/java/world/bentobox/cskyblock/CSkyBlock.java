...
import world.bentobox.cskyblock.commands.IslandAboutCommand;
import world.bentobox.cskyblock.generators.ChunkGeneratorWorld;

/**
 * Main CSkyBlock class - provides an island minigame in the sky
 * @author tastybento
 * @author Poslovitch
 */
public class CSkyBlock extends GameModeAddon implements Listener {
    ...
    private boolean loadSettings() {
        ...
        if (settings == null) {
            // Disable
            logError("CSkyBlock settings could not load! Addon disabled.");
    ...
    public void onReload() {
        if (loadSettings()) {
            log("Reloaded CSkyBlock settings");
        }
    }
    ...
    public void createWorlds() {
        ...
        if (settings.isNetherGenerate()) {
            if (getServer().getWorld(worldName + NETHER) == null) {
                log("Creating CSkyBlock's Nether...");
            }
        ...
        if (settings.isEndGenerate()) {
            if (getServer().getWorld(worldName + THE_END) == null) {
                log("Creating CSkyBlock's End World...");
            }
