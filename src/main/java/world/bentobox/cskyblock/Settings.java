 ...
 * @author Tastybento
 */
@StoreAt(filename="config.yml", path="addons/CSkyBlock") // Explicitly call out what name this should have.
@ConfigComment("CSkyBlock Configuration [version]")
public class Settings implements WorldSettings {
    ...
    @ConfigEntry(path = "cskyblock.command.island", since = "1.3.0")
    private String playerCommandAliases = "cisland cis cskyblock csb";

    @ConfigComment("The island admin command.")
    @ConfigComment("To define alias, just separate commands with white space.")
    @ConfigEntry(path = "cskyblock.command.admin", since = "1.3.0")
    private String adminCommandAliases = "cbsbadmin cbsb cskyblockadmin csbadmin csba";
    ...
    @ConfigEntry(path = "cskyblock.command.new-player-action", since = "1.13.1")
    ...
    @ConfigEntry(path = "cskyblock.command.default-action", since = "1.13.1")
    private String defaultPlayerAction = "go";

    /*      WORLD       */
    @ConfigComment("Friendly name for this world. Used in admin commands. Must be a single word")
    @ConfigEntry(path = "world.friendly-name")
    private String friendlyName = "CSkyBlock";

    @ConfigComment("Name of the world - if it does not exist then it will be generated.")
    @ConfigComment("It acts like a prefix for nether and end (e.g. cskyblock_world, cskyblock_world_nether, cskyblock_world_end)")
    @ConfigEntry(path = "world.world-name")
    private String worldName = "cskyblock_world";
    ...
    @ConfigComment("or set this permission: cskyblock.island.range.<number>")
    ...
    @ConfigComment("Players can have the cskyblock.coop.maxsize.<number> permission to be bigger but")
    @ConfigComment("permission size cannot be less than the default below. ")
    ...
    @ConfigComment("Players can have the cskyblock.trust.maxsize.<number> permission to be bigger but")
    @ConfigComment("permission size cannot be less than the default below. ")
    ...
    @ConfigComment("CSkyBlock blocked mobs.")
    @ConfigComment("List of mobs that should not spawn in CSkyBlock.")
